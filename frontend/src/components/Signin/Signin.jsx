...
const Signin = ({ loadUser, saveAuthTokenInSession, toggleSignIn }) => {
  ...
  useEffect(() => {
    if (emailRef.current.validity.valid === true && signInState.showEmailError === true) {
      setSignInState({ ...signInState, showEmailError: false });
    } else if (emailRef.current.validity.valid === false && signInState.showEmailError === false) {
      setSignInState({ ...signInState, showEmailError: true });
    }
    if (passwordRef.current.validity.valid === true && signInState.showPasswordError === true) {
      setSignInState({ ...signInState, showPasswordError: false });
    } else if (passwordRef.current.validity.valid === false && signInState.showPasswordError === false) {
      setSignInState({ ...signInState, showPasswordError: true });
    }
  }, [signInState]);

  const onEmailChange = (event) => {
    setSignInState({ ...signInState, signInEmail: event.target.value });
  };
  ...
  const onPasswordChange = (event) => {
    setSignInState({ ...signInState, signInPassword: event.target.value });
  };
