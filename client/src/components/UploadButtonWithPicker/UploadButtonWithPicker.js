      ...
      if (someObject) {
        ...
        if (height > width) {
          ...
          try {
            ...
            console.log(
              `error in uploadButtonWithPicker in "someFunction" line 40`
            );
          }
        }
        // check if image is landscape
          ...
          try {
            ...
            console.log(
              `error in uploadButtonWithPicker in "someFunction" line 57`
            );
          }
        }
        // else return a square image
          ...
          try {
            ...
            console.log(
              `error in uploadButtonWithPicker in "someFunction" line 73`
            );
          }
        }
      }
